...
<script>
    ...
    var pusher = new Pusher("qpugiwozkev8qjmmbibn", {
        cluster: "",
        wsHost: "127.0.0.1",
        wsPort: 8080,
    ...
    var ch = pusher.subscribe("message-channel");
    console.log("Message ", ch);
    ch.bind("MessageSent", function (data) {
        console.log("Message ", data);
    });
    ch.bind('MessageSent', data => console.log('received:', data));
    // fallback: lihat semua event
    ch.bind_global((ev, d) => console.log('global', ev, d));
</script>
